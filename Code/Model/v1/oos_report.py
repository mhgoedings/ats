...
class OosReport(Base):
    __tablename__ = 'oos_reports'
    id = Column(Integer, primary_key=True)
    strat_id = Column(Integer, ForeignKey('prototypes.id'))
    ...
    oos_param_history = Column(JSONB,nullable=True)
    ...
    trades = relationship("OosTrade", backref='oos_report', lazy='dynamic')
