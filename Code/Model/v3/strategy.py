...
class Strategy(Base):
    ...
    ## market internals
    mi_opt = Column(Integer,nullable=True, default=0)
    mi_id = Column(Integer, ForeignKey('market_internals.id'))
    mi_n1 = Column(Integer, nullable=True)
    mi_n2 = Column(Integer, nullable=True)

    ## dow filter
    dow_opt = Column(Integer,nullable=True, default=0)
    dow_id = Column(Integer, nullable=True)
    dow_n1 = Column(Integer, nullable=True)
    dow_n2 = Column(Integer, nullable=True)
